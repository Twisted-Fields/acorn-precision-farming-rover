...
odrv0 = OdriveManager(path='/dev/ttySC0', serial_number='336B31643536').find_odrive()
...
odrv0.axis1.controller.config.vel_gain = -0.008
...
if True:
    ...
    delay = 2
    positions = [base_position, base_position - offset, base_position, base_position + offset]
    while True:
